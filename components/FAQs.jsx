    ...
    return (
        <Row sidePadding="huge" gutters="huge" marginBottom="small">
            ...
            <Portion>
                ...
                <img style={{ width: "30%", margin: "auto" }} src="https://yakshaG.github.io/project-pratima/docs-images/base-grid-dd.png" alt="base-grid" />
            </Portion>
            <Portion>
                ...
                <img style={{ width: "30%", margin: "auto" }} src="https://yakshaG.github.io/project-pratima/docs-images/stroke-dd.png" alt="stroke" />
            </Portion>
            <Portion>
            ...
            <Portion>
                ...
                <img style={{ width: "50%", margin: "auto" }} src="https://yakshaG.github.io/project-pratima/docs-images/theme-dd.png" alt="theme" />
            </Portion>
            <Portion>
                <Heading as="h5">Success</Heading>
                <Text>Use tick and green circle. Any size, minimum 24 x 24 dp.</Text>
                <img style={{ width: "75%", margin: "auto" }} src="https://yakshaG.github.io/project-pratima/docs-images/success-dd.png" alt="success" />
            </Portion>
            <Portion>
                <Heading as="h5">Failure</Heading>
                <Text>Use a white cross on a red circle.</Text>
                <img style={{ width: "75%", margin: "auto" }} src="https://yakshaG.github.io/project-pratima/docs-images/failure-dd.png" alt="failure" />
            </Portion>
        </Row>
    )
}
